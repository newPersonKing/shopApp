...
import com.test.myshop.WareListActivity;
import com.test.myshop.adapter.HomeCatgoryAdapter;
import com.test.myshop.adapter.decoration.CardViewtemDecortion;
import com.test.myshop.bean.Banner;
import com.test.myshop.bean.Campaign;
import com.test.myshop.bean.HomeCampaign;
import com.test.myshop.http.BaseCallback;
    ...
    private void initRecyclerView() {
        ...
        httpHelper.get(Contants.API.CAMPAIGN_HOME, new BaseCallback<List<HomeCampaign>>() {
            ...
            public void onSuccess(Response response, List<HomeCampaign> homeCampaigns) {
                ...
                Collections.reverse(homeCampaigns);
